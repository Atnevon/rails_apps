class WelcomeController < ApplicationController
  def index
  		...
  		if params[:city] != nil
			...
			response = HTTParty.get("http://api.wunderground.com/api/35d8d478216f749a/geoloco/conditions/q/#{params[:state]}/#{params[:city]}.json")
  ...
  def test
  		response = HTTParty.get("http://api.wunderground.com/api/35d8d478216f749a/conditions/q/NC/Charlotte.json")
